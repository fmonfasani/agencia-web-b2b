---
description: Analiza el repositorio de Agencia B2B y propone mejoras usando Codex y sus herramientas de agente.
---
...
4. El agente deberá actuar como Arquitecto de Software y proponer un plan de acción técnica centrado en Revenue OS.
