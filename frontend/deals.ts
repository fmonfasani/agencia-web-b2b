...
// [PHASE1.5] ⚠ Prisma detected → // [PHASE1.5] ⚠ Prisma detected → // [PHASE1] TODO: remove Prisma → import { DealStage } from "@prisma/client";
...
// [PHASE1] TODO: Replace DB calls with API layer (src/lib/api)
