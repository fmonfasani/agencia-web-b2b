...
export default function ObservabilityOverview({ health, finops }: Props) {
    return (
            ...
            {finops?.alerts && finops.alerts.length > 0 && (
                ...
                >
                    ...
                    <div className="flex-1">
                        <h3 className="text-rose-800 font-bold uppercase text-xs tracking-wider">Alertas del Sistema</h3>
