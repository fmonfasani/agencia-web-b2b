...
// [PHASE1.5] ⚠ Prisma detected → // [PHASE1.5] ⚠ Prisma detected →         (prisma.apiCostEvent.findMany as any).mockResolvedValue(mockEvents);
...
// [PHASE1.5] ⚠ Prisma detected → // [PHASE1.5] ⚠ Prisma detected →         (prisma.apiCostEvent.findMany as any).mockResolvedValue([]);
